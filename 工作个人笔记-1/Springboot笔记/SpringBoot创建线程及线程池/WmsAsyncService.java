...
import com.jeesite.common.util.HttpPostUtil;
...
public class WmsAsyncService {
    ...
    public String transferOrderToWms(RecycleOrder recycleOrder){
        ...
        //recycleOrder.setBuyerName("测试员");  //测试
        ...
        while(it.hasNext()){
            ...
            roct.setWeight(roct.getWeight()*1000);   //千克改为克
            newList.add(roct);
        }

        String url = "http://localhost:8083/wms/wh/warehousingOrder/saveOrderToWms";

...
#####  [2011年09月07日 ](https://coolshell.cn/articles/5426.html) [陈皓](https://coolshell.cn/articles/author/haoel) 评论 [610 条评论](https://coolshell.cn/articles/5426.html#comments) 1,319,845 人阅读

**个人注：原文使用md文件格式，有的字复制补全，参考word同名文档**
...
5. 打开/保存/退出/改变文件
   ...
   > - `:bn` 和 `:bp` → 你可以同时打开很多文件，使用这两个命令来切换下一个或上一个文件。（陈皓注：我喜欢使用:n到下一个文件，例， :n  /root/mynote.txt，需指定文件名字）
...
> - `2dd` → 删除2行
> - `3p` → 粘贴文本3次
> - `100idesu [ESC]`（个人注：100是次数，i是插入命令，desu是内容，按完Esc就会执行） → 会写下 “desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu desu “
> - `.` → 重复上一个命令—— 100 “desu “.
...
前面，我们看到了 ``的示例 （在Windows下应该是<C-q>），我们可以使用 `v` 和 `V`。一但被选好了，你可以做下面的事：
